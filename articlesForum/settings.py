"""
Django settings for articlesForum project.
...
ROOT_URLCONF = 'articlesForum.urls'
...
WSGI_APPLICATION = 'articlesForum.wsgi.application'
...
LOGIN_REDIRECT_URL = '/articles/update-user'
